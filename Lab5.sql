CREATE OR REPLACE TABLE nested(
    ...
    left_num INT NOT NULL UNIQUE check(left_num > 0),
    right_num INT NOT NULL UNIQUE check (right_num > 0),
...
CODE 
  EXECUTE "SELECT left_num, right_num FROM nested" INTO left_num, right_num;
...
CODE
  ...
  EXECUTE "INSERT INTO nested(node_name, left_num, right_num) VALUES(?,?,?)", 
    new_node_name, parent_right_num + 1, parent_right_num + 2;
